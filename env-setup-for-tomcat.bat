...
set PATH="C:\jdk1.8.0_121\bin";%PATH%
...
set CLASSPATH=%CLASSPATH%;C:\apache-tomcat-7.0.34\lib\mysql-connector-java-5.1.42-bin.jar
set CLASSPATH=%CLASSPATH%;C:\apache-tomcat-7.0.34\lib\jstl-1.2.jar
set CLASSPATH=%CLASSPATH%;C:\apache-tomcat-7.0.34\lib\mongo-java-driver-3.4.2.jar
