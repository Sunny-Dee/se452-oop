...
//            Product accessory = SaxParserDataStore.accessories.get(name);
...
//			Console console;
//			console = (Console) SaxParserDataStore.consoles.get(name);
//			OrderItem orderitem = new OrderItem(console.getName(), console.getPrice(), console.getImage(), console.getRetailer());
//			orderItems.add(orderitem);
//		}
//		if(type.equals("games")){
//			Product game = null;
//			game = SaxParserDataStore.getProductMap("games").get(name);   //games.get(name);
//			OrderItem orderitem = new OrderItem(game.getName(), game.getPrice(), game.getImage(), game.getRetailer());
//			orderItems.add(orderitem);
//		}
...
//	public HashMap<String, Product> getGames(){
//			HashMap<String, Product> hm = new HashMap<>();
//			hm.putAll(SaxParserDataStore.getProductMap("games"));
//			return hm;
//	}
//	
//	/* getTablets Functions returns the Hashmap with all Tablet in the store.*/
