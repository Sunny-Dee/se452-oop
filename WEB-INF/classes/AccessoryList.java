...
public class AccessoryList extends ProductList {
    
    public AccessoryList(){
        super("accessory", "Accessories", SaxParserDataStore.allProducts.get("accessory"));
    }
...
//		{
//		
//	    Product accessory= SaxParserDataStore.accessories.get(acc.getValue());
