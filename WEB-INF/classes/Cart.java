...
public class Cart extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        utility.storeProduct(name, type, maker);
    ...
    protected void displayCart(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<OrderItem>items = utility.getCartItems();
        ...
        if (utility.CartCount() > 0) {
            ...
            pw.print("<tr><th></th><th>Total</th><th>" + formatDollars(total) + "</th>");
    ...
    private String formatDollars(double total){
